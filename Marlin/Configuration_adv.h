...
//
  ...
  //#define HEATER_CHAMBER_PIN      44   // Required heater on/off pin (example: SKR 1.4 Turbo HE1 plug)
...
//#define X_DUAL_STEPPER_DRIVERS
  ...
  #define INVERT_X2_VS_X_DIR Enable // Enable if X2 direction signal is opposite to X
...
//#define Y_DUAL_STEPPER_DRIVERS
  ...
  #define INVERT_Y2_VS_Y_DIR Enable  // Enable if Y2 direction signal is opposite to Y
